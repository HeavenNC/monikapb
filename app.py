...
line_bot_api = LineBotApi('nlOcNGztEKSToxfBZFoUOXZ4VRsrlI9meqAVxnW0JuY+tCMXuV6255aU3IrKqu/AQsziYwRLJl1H10mI8LTqH/RiEPP1QxNN8ghVbHnZxugdYAaNZ2chl985214wE9e+rv4/frjg1eX2NBO5zGlfqwdB04t89/1O/w1cDnyilFU=')
handler = WebhookHandler('78865b782c2f82c2acec952f3ab66ab5')
adminid = 'u9e36c0029c31e1c1d6c36a8a7c13ff37'
botstart = time.time()
workdir = os.getcwd()
myanimelist = MAL()
    ...
    try:
        ...
        if data['find'] == True:
            if len(data['url']) == 0:
                ...
                for a in TB:
                    kirimlist = {}
                    kirimlist['alt'] = 'Monika BOT Insta Story'
    ...
    try:
        if mode == 0:
            ...
            for a in range(len(listpict)):
                ...
                TB.append(isi_TB)
            dat = {}
            dat['alt'] = 'Monika BOT Deviantart Search'
            dat['template'] = templateBuilder(amon, tipe, TB)
            replyCarrouselMessage(token, dat)
        elif mode == 1:
            find = devapi.browse()
            ...
            for a in range(len(listpict)):
                ...
                TB.append(isi_TB)
            dat = {}
            dat['alt'] = 'Monika BOT Deviantart Hot'
            dat['template'] = templateBuilder(amon, tipe, TB)
            replyCarrouselMessage(token, dat)
    except Exception as e:
        if berapa < 1:
    ...
    try:
        if mode == 0:
            ...
            for a in range(amon):
                ...
                TB.append(isi_TB)
            data = {}
            data['alt'] = 'Monika BOT Top Airing Anime'
            ...
            for a in range(amon):
                ...
                TB.append(isi_TB)
            data = {}
            data['alt'] = 'Monika BOT Top Upcoming Anime'
            data['template'] = templateBuilder(amon, tipe, TB)
            replyCarrouselMessage(token, data)
        elif mode == 2:
            ...
            for a in range(amon):
                ...
                TB.append(isi_TB)
            data = {}
            data['alt'] = 'Monika BOT Most Popular Anime'
            data['template'] = templateBuilder(amon, tipe, TB)
            replyCarrouselMessage(token, data)
        elif mode == 3:
            ...
            for a in range(amon):
                ...
                TB.append(isi_TB)
            data = {}
            data['alt'] = 'Monika BOT Anime Search'
            data['template'] = templateBuilder(amon, tipe, TB)
            replyCarrouselMessage(token, data)
        elif mode == 5:
            ...
            custom = []
            for a in TB:
                kirimin = TemplateSendMessage(alt_text = 'Monika BOT MAL Promotional Video', template = templateBuilder(len(a), tipe, a))
    ...
    try:
        if mode == 0:
            ...
            for a in range(amon):
                ...
                TB.append(isi_TB)
            data = {}
            data['alt'] = 'Monika BOT pixiv search'
            data['template'] = templateBuilder(amon, tipe, TB)
            replyCarrouselMessage(token, data)
        elif mode == 1:
            ...
            for a in range(amon):
                ...
                TB.append(isi_TB)
            data = {}
            data['alt'] = 'Monika BOT pixiv rank'
            data['template'] = templateBuilder(amon, tipe, TB)
            replyCarrouselMessage(token, data)
    except Exception as e:
        if berapa < 1:
...
def animekompi(token):
    try:
        ...
        custom = []
        for a in TB:
            custom.append(TemplateSendMessage(alt_text='Monika BOT Animekompi', template=templateBuilder(len(a), tipe, a)))
        customMessage(token, custom)
    except Exception as e:
        raise e
...
def cuaca(token, mode, query=None):
    try:
        if mode == 0:
            ...
            custom = []
            for a in TB:
                custom.append(TemplateSendMessage(alt_text='Monika BOT Cuaca', template=templateBuilder(len(a), tipe, a)))
            customMessage(token, custom)
        elif mode == 1:
            query = query.split(' | ')
    ...
    try:
        if mode == 0:
            ...
            for a in range(amon):
                ...
                TB.append(isi_TB)
            data = {}
            data['alt'] = 'Monika BOT youtube help'
            data['template'] = templateBuilder(amon, tipe, TB)
            replyCarrouselMessage(token, data)
        elif mode == 2:
            TB = []
            ...
            for a in range(amon):
                ...
                TB.append(isi_TB)
            data = {}
            data['alt'] = 'Monika BOT instagram help'
            data['template'] = templateBuilder(amon, tipe, TB)
            replyCarrouselMessage(token, data)
        elif mode == 3:
            TB = []
            ...
            for a in TB:
                kirimlist = {}
                kirimlist['alt'] = 'Monika BOT stuff help'
                kirimlist['template'] = templateBuilder(len(a), tipe, a)
                kirimasli = TemplateSendMessage(alt_text=kirimlist['alt'], template=kirimlist['template'])
                cus.append(kirimasli)
            customMessage(token, cus)
            ...
            for a in range(amon):
                ...
                TB.append(isi_TB)
            data = {}
            data['alt'] = 'Monika BOT about help'
            data['template'] = templateBuilder(amon, tipe, TB)
            replyCarrouselMessage(token, data)
        elif mode == 5:
            TB = []
            ...
            amon = len(text)
            data = {}
            data['alt'] = 'Monika BOT anime help'
            data['template'] = templateBuilder(amon, tipe, TB)
            replyCarrouselMessage(token, data)
        elif mode == 6:
            TB = []
            ...
            amon = len(text)
            data = {}
            data['alt'] = 'Monika BOT pixiv help'
            data['template'] = templateBuilder(amon, tipe, TB)
            replyCarrouselMessage(token, data)
        elif mode == 7:
            TB = []
            ...
            amon = len(text)
            data = {}
            data['alt'] = 'Monika BOT Deviantart help'
            data['template'] = templateBuilder(amon, tipe, TB)
            replyCarrouselMessage(token, data)
        elif mode == 8:
            TB = []
            ...
            amon = len(action)
            data = {}
            data['alt'] = 'Monika BOT Tebak Gambar help'
            data['template'] = templateBuilder(amon, tipe, TB)
            replyCarrouselMessage(token, data)
        elif mode == 9:
...
def handle_join(event):
    try:
        ...
        data = {}
        data['alt'] = 'Monika BOT Added'
        data['tumbnail'] = None
        data['title'] = 'Monika BOT'
    ...
    try:
        if msgtext.lower() in ['help', 'key', 'cmd', 'command']:
            ...
            for a in range(0, amon):
                ...
                TB.append(isi_TB)
            data = {}
            data['alt'] = 'Monika BOT youtube-search'
            data['template'] = templateBuilder(amon, tipe, TB)
            ...
            data['alt'] = 'Monika BOT Admin'
            data['tumbnail'] = None
            data['title'] = data['displayName']
            data['text'] = 'developer'
            data['action'] = [actionBuilder(1, ['uri'], ['add'], ['line://ti/p/~syifaabyananta'])]
            replyTemplateMessage(reply_token, data)
